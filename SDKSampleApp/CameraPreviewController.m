...
#pragma mark CameraPreviewController (GoCoder SDK Sample App) -

NSString *const SDKSampleSavedConfigKey = @"SDKSampleSavedConfigKey";
NSString *const SDKSampleAppLicenseKey = @"GOSK-6443-0101-CD19-EB0F-E04E";

@interface CameraPreviewController () <WOWZStatusCallback, WOWZVideoSink, WOWZAudioSink, WOWZVideoEncoderSink, WOWZAudioEncoderSink, WOWZDataSink>
...
- (void) dealloc {
    ...
    NSLog(@"CameraPreviewController - goodbye");
}
...
- (IBAction) didTapBroadcastButton:(id)sender {
    ...
    if (configError != nil) {
        [CameraPreviewController showAlertWithTitle:@"Incomplete Streaming Settings" error:configError presenter:self];
        return;
    }
...
- (void) onWOWZEvent:(WOWZStatus *) goCoderStatus {
    ...
    dispatch_async(dispatch_get_main_queue(), ^{
        ...
        if (!haveSeenAlertForEvent) {
            [CameraPreviewController showAlertWithTitle:@"Live Streaming Event" status:goCoderStatus presenter:self];
...
- (void) onWOWZError:(WOWZStatus *) goCoderStatus {
    ...
    dispatch_async(dispatch_get_main_queue(), ^{
        [CameraPreviewController showAlertWithTitle:@"Live Streaming Error" status:goCoderStatus presenter:self];
