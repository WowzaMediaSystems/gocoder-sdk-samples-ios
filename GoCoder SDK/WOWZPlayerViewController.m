...
- (IBAction) didTapCloseButton:(id)sender {
    if([self.player currentPlayState] == WOWZPlayerStatePlaying || [self.player currentPlayState] == WOWZPlayerStateBuffering || [self.player currentPlayState] == WOWZPlayerStateConnecting){
        [self.player stop];
    }
